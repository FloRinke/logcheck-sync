...
setup(name="logcheck-sync",
      ...
      packages=['logcheck-sync'],
      scripts=['bin/logcheck-sync'],
      data_files=[('/etc/logcheck-sync', ['logcheck-sync/logcheck-sync.conf']),
                  ('/var/lib/logcheck-sync', ['logcheck-sync/logging.conf'])
                  ],
